...
export default function App({navigation}) {
  ...
  const [ image, setImage ] = useState( [require( '../assets/6.png'), require( '../assets/5.png')]  )//кубик
      ...
      <LinearGradient
        ...
        onStartShouldSetResponder={() => {setDropDownList([]); setColorList([])}}>
          ...
          <TouchableHighlight underlayColor={'rgba(255, 0, 255,0)'} onPress={go}>
            ...
            source={image[0]}
            style={[styles.image,
            {transform: [{translateX: x1}, {rotate: 0-z1 + 'deg'}]}
            ]}
            />
          </TouchableHighlight>
          ...
          <TouchableHighlight underlayColor={'rgba(255, 0, 255,0)'} onPress={go}>
            ...
            source={image[1]}
            style={[styles.image,
            {transform: [{translateX: 0-x1}, {rotate: z1 + 'deg'}]}
            ]}
            />
          </TouchableHighlight>
